...
if (is_file(__DIR__ .'/coagroup.php-handler.php')) {
	require_once __DIR__ .'/coagroup.php-handler.php';
}

/**
 * ent/financial/coagroup/coagroup.php
 *
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\coagroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new coagroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
