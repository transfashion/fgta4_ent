...
import * as hnd from  './coagroup-edit-hnd.mjs'
...
export async function init(opt) {
	...
	obj.cbo_coagroup_parent.name = 'pnl_edit-cbo_coagroup_parent'		
	new fgta4slideselect(obj.cbo_coagroup_parent, {
		...
		OnDataLoading: (criteria, options) => {
			...
			if (typeof hnd.cbo_coagroup_parent_dataloading === 'function') {
				hnd.cbo_coagroup_parent_dataloading(criteria, options);
			}						
		},					
