...
ALTER TABLE `mst_coa` ADD COLUMN IF NOT EXISTS  `coa_descr` varchar(255)   AFTER `coa_nameshort`;
ALTER TABLE `mst_coa` ADD COLUMN IF NOT EXISTS  `curr_id` varchar(10)   AFTER `coa_descr`;
ALTER TABLE `mst_coa` ADD COLUMN IF NOT EXISTS  `coamodel_id` varchar(10) NOT NULL  AFTER `curr_id`;
ALTER TABLE `mst_coa` ADD COLUMN IF NOT EXISTS  `coareport_id` varchar(10) NOT NULL  AFTER `coamodel_id`;
ALTER TABLE `mst_coa` ADD COLUMN IF NOT EXISTS  `coa_dk` varchar(1) NOT NULL  AFTER `coareport_id`;
ALTER TABLE `mst_coa` ADD COLUMN IF NOT EXISTS  `coa_mp` int(1) NOT NULL DEFAULT 1 AFTER `coa_dk`;
ALTER TABLE `mst_coa` ADD COLUMN IF NOT EXISTS  `coa_isdisabled` tinyint(1) NOT NULL DEFAULT 0 AFTER `coa_mp`;
...
ALTER TABLE `mst_coa` MODIFY COLUMN IF EXISTS  `coa_descr` varchar(255)    AFTER `coa_nameshort`;
ALTER TABLE `mst_coa` MODIFY COLUMN IF EXISTS  `curr_id` varchar(10)    AFTER `coa_descr`;
ALTER TABLE `mst_coa` MODIFY COLUMN IF EXISTS  `coamodel_id` varchar(10) NOT NULL   AFTER `curr_id`;
ALTER TABLE `mst_coa` MODIFY COLUMN IF EXISTS  `coareport_id` varchar(10) NOT NULL   AFTER `coamodel_id`;
ALTER TABLE `mst_coa` MODIFY COLUMN IF EXISTS  `coa_dk` varchar(1) NOT NULL   AFTER `coareport_id`;
ALTER TABLE `mst_coa` MODIFY COLUMN IF EXISTS  `coa_mp` int(1) NOT NULL DEFAULT 1  AFTER `coa_dk`;
ALTER TABLE `mst_coa` MODIFY COLUMN IF EXISTS  `coa_isdisabled` tinyint(1) NOT NULL DEFAULT 0  AFTER `coa_mp`;
