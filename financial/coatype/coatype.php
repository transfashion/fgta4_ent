...
if (is_file(__DIR__ .'/coatype.php-handler.php')) {
	require_once __DIR__ .'/coatype.php-handler.php';
}

/**
 * ent/financial/coatype/coatype.php
 *
 * ===================================================================
 * Entry point Program Module coatype
 * ===================================================================
 ...
 * awal dibuat tanggal 25/08/2024
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\coatype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new coatype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
