...
if (is_file(__DIR__ .'/cob.php-handler.php')) {
	require_once __DIR__ .'/cob.php-handler.php';
}

/**
 * ent/financial/cob/cob.php
 *
 * ===================================================================
 * Entry point Program Module cob
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\cob_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new cob_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
