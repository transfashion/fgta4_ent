...
if (is_file(__DIR__ .'/bank.php-handler.php')) {
	require_once __DIR__ .'/bank.php-handler.php';
}

/**
 * ent/financial/bank/bank.php
 *
 * ===================================================================
 * Entry point Program Module bank
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\bank_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new bank_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
