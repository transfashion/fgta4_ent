...
if (is_file(__DIR__ .'/bankrekening.php-handler.php')) {
	require_once __DIR__ .'/bankrekening.php-handler.php';
}

/**
 * ent/financial/bankrekening/bankrekening.php
 *
 * ===================================================================
 * Entry point Program Module bankrekening
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\bankrekening_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new bankrekening_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
