...
/**
 * ent/financial/bankrekening/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header bankrekening (mst_bankrekening)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('bank_name', 'bank_id', $record, 'mst_bank', 'bank_name', 'bank_id');
