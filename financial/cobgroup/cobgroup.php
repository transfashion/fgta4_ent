...
if (is_file(__DIR__ .'/cobgroup.php-handler.php')) {
	require_once __DIR__ .'/cobgroup.php-handler.php';
}

/**
 * ent/financial/cobgroup/cobgroup.php
 *
 * ===================================================================
 * Entry point Program Module cobgroup
 * ===================================================================
 ...
 * awal dibuat tanggal 30/08/2024
 * terakhir di generate tanggal 30/08/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\cobgroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new cobgroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
