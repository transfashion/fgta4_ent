...
/**
 * ent/financial/cobgroup/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header cobgroup (mst_cobgroup)
...
$API = new class extends cobgroupBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.cobgroup_id LIKE CONCAT('%', :search, '%') OR A.cobgroup_name LIKE CONCAT('%', :search, '%') "
			];
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('cobgroup_parent_name', 'cobgroup_parent', $record, 'mst_cobgroup', 'cobgroup_name', 'cobgroup_id');
