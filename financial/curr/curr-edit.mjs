...
import * as hnd from  './curr-edit-hnd.mjs'
...
const obj = {
	...
	txt_curr_name: $('#pnl_edit-txt_curr_name'),
	txt_curr_descr: $('#pnl_edit-txt_curr_descr'),
	chk_curr_isdisabled: $('#pnl_edit-chk_curr_isdisabled')
}
