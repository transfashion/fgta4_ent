...
if (is_file(__DIR__ .'/curr.php-handler.php')) {
	require_once __DIR__ .'/curr.php-handler.php';
}

/**
 * ent/financial/curr/curr.php
 *
 * ===================================================================
 * Entry point Program Module curr
 * ===================================================================
 ...
 * terakhir di generate tanggal 06/09/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\curr_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new curr_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
