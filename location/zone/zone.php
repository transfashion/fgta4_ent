...
if (is_file(__DIR__ .'/zone.php-handler.php')) {
	require_once __DIR__ .'/zone.php-handler.php';
}

/**
 * ent/location/zone/zone.php
 *
 * ===================================================================
 * Entry point Program Module zone
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\zone_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new zone_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
