...
if (is_file(__DIR__ .'/landtype.php-handler.php')) {
	require_once __DIR__ .'/landtype.php-handler.php';
}

/**
 * ent/location/landtype/landtype.php
 *
 * ===================================================================
 * Entry point Program Module landtype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\landtype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new landtype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
