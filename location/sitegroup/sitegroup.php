...
if (is_file(__DIR__ .'/sitegroup.php-handler.php')) {
	require_once __DIR__ .'/sitegroup.php-handler.php';
}

/**
 * ent/location/sitegroup/sitegroup.php
 *
 * ===================================================================
 * Entry point Program Module sitegroup
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\sitegroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new sitegroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
