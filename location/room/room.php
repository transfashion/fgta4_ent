...
if (is_file(__DIR__ .'/room.php-handler.php')) {
	require_once __DIR__ .'/room.php-handler.php';
}
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\room_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new room_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
