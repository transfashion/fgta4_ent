...
import * as hnd from  './site-unitgrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editunitgrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editunitgrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
