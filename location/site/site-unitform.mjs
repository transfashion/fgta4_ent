...
import * as hnd from  './site-unitform-hnd.mjs'
...
const obj = {
	txt_siteunit_id: $('#pnl_editunitform-txt_siteunit_id'),
	cbo_unit_id: $('#pnl_editunitform-cbo_unit_id'),
	cbo_dept_id: $('#pnl_editunitform-cbo_dept_id'),
	txt_site_id: $('#pnl_editunitform-txt_site_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_siteunit_id,
		autoid: true,
		logview: 'mst_siteunit',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_dept_id.name = 'pnl_editunitform-cbo_dept_id'		
