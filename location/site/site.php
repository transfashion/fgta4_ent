...
if (is_file(__DIR__ .'/site.php-handler.php')) {
	require_once __DIR__ .'/site.php-handler.php';
}

/**
 * ent/location/site/site.php
 *
 * ===================================================================
 * Entry point Program Module site
 * ===================================================================
 ...
 * terakhir di generate tanggal 24/03/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\site_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new site_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
