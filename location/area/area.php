...
if (is_file(__DIR__ .'/area.php-handler.php')) {
	require_once __DIR__ .'/area.php-handler.php';
}

/**
 * ent/location/area/area.php
 *
 * ===================================================================
 * Entry point Program Module area
 * ===================================================================
 ...
 * terakhir di generate tanggal 24/07/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\area_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new area_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
