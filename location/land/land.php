...
if (is_file(__DIR__ .'/land.php-handler.php')) {
	require_once __DIR__ .'/land.php-handler.php';
}

/**
 * ent/location/land/land.php
 *
 * ===================================================================
 * Entry point Program Module land
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\land_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new land_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
