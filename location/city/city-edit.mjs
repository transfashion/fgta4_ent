...
import * as hnd from  './city-edit-hnd.mjs'
...
export async function init(opt) {
	...
	obj.cbo_prov_id.name = 'pnl_edit-cbo_prov_id'		
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_prov_id, record.prov_id, record.prov_name)
