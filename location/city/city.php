...
if (is_file(__DIR__ .'/city.php-handler.php')) {
	require_once __DIR__ .'/city.php-handler.php';
}

/**
 * ent/location/city/city.php
 *
 * ===================================================================
 * Entry point Program Module city
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\city_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new city_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
