...
if (is_file(__DIR__ .'/country.php-handler.php')) {
	require_once __DIR__ .'/country.php-handler.php';
}

/**
 * ent/location/country/country.php
 *
 * ===================================================================
 * Entry point Program Module country
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\country_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new country_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
