...
if (is_file(__DIR__ .'/prov.php-handler.php')) {
	require_once __DIR__ .'/prov.php-handler.php';
}

/**
 * ent/location/prov/prov.php
 *
 * ===================================================================
 * Entry point Program Module prov
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\prov_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new prov_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
