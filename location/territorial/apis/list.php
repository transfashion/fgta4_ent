...
/**
 * ent/location/territorial/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header territorial (mst_territorial)
...
$API = new class extends territorialBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.territorial_id LIKE CONCAT('%', :search, '%') OR A.territorial_name LIKE CONCAT('%', :search, '%') "
			];
