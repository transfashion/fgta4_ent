...
import * as hnd from  './territorial-edit-hnd.mjs'
...
const obj = {
	txt_territorial_id: $('#pnl_edit-txt_territorial_id'),
	txt_territorial_name: $('#pnl_edit-txt_territorial_name'),
	txt_territorial_descr: $('#pnl_edit-txt_territorial_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_territorial_id,
		autoid: false,
		logview: 'mst_territorial',
...
function form_idsetup(options) {
	var objid = obj.txt_territorial_id
