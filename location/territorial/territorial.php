...
if (is_file(__DIR__ .'/territorial.php-handler.php')) {
	require_once __DIR__ .'/territorial.php-handler.php';
}

/**
 * ent/location/territorial/territorial.php
 *
 * ===================================================================
 * Entry point Program Module territorial
 * ===================================================================
 ...
 * awal dibuat tanggal 27/08/2024
 * terakhir di generate tanggal 27/08/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\territorial_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new territorial_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
