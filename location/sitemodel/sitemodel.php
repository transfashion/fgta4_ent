...
if (is_file(__DIR__ .'/sitemodel.php-handler.php')) {
	require_once __DIR__ .'/sitemodel.php-handler.php';
}

/**
 * ent/location/sitemodel/sitemodel.php
 *
 * ===================================================================
 * Entry point Program Module sitemodel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\sitemodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new sitemodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
