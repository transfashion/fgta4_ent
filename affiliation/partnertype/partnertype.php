...
if (is_file(__DIR__ .'/partnertype.php-handler.php')) {
	require_once __DIR__ .'/partnertype.php-handler.php';
}
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\partnertype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new partnertype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
