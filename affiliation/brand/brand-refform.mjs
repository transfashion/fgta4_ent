...
const obj = {
	...
	txt_brandref_otherdata: $('#pnl_editrefform-txt_brandref_otherdata'),
	txt_brandref_notes: $('#pnl_editrefform-txt_brandref_notes'),
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.brand_name)
