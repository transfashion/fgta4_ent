...
if (is_file(__DIR__ .'/brand.php-handler.php')) {
	require_once __DIR__ .'/brand.php-handler.php';
}
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\brand_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new brand_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
