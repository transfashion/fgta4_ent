 ...
 * dari tabel partner brand (mst_brandpartner)
 *
...
$API = new class extends brandBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$sqlUpdateField  = [
					'brandpartner_id', 'partner_id', 'brand_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"brandpartner_id" => $obj->brandpartner_id
				];
				...
				$sqlFieldList = [
					'brandpartner_id' => 'A.`brandpartner_id`', 'partner_id' => 'A.`partner_id`', 'brand_id' => 'A.`brand_id`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_brandpartner A";
				$sqlWhere = $where->sql;
