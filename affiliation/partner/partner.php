...
if (is_file(__DIR__ .'/partner.php-handler.php')) {
	require_once __DIR__ .'/partner.php-handler.php';
}
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\partner_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new partner_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
