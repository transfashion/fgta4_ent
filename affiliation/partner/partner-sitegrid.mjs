...
import * as hnd from  './partner-sitegrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editsitegrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editsitegrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
