 ...
 * dari tabel type partner (mst_partnerastype)
 *
...
$API = new class extends partnerBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$sqlUpdateField  = [
					'partnerastype_id', 'partnertype_id', 'partner_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"partnerastype_id" => $obj->partnerastype_id
				];
				...
				$sqlFieldList = [
					'partnerastype_id' => 'A.`partnerastype_id`', 'partnertype_id' => 'A.`partnertype_id`', 'partner_id' => 'A.`partner_id`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_partnerastype A";
				$sqlWhere = $where->sql;
