...
$API = new class extends partnerBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$sqlUpdateField  = [
					'partnercontact_id', 'partnercontact_name', 'partnercontact_position', 'partnercontact_mobilephone',
					'partnercontact_email', 'partnecontact_isdisabled', 'partnecontact_iscontract', 'partnecontact_isinvoice',
					'partner_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"partnercontact_id" => $obj->partnercontact_id
				];
