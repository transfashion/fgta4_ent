 ...
 * dari tabel site partner (mst_partnersite)
 *
...
$API = new class extends partnerBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$sqlUpdateField  = [
					'partnersite_id', 'site_id', 'partner_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"partnersite_id" => $obj->partnersite_id
				];
				...
				$sqlFieldList = [
					'partnersite_id' => 'A.`partnersite_id`', 'site_id' => 'A.`site_id`', 'partner_id' => 'A.`partner_id`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_partnersite A";
				$sqlWhere = $where->sql;
