...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_partnerbilltype';
		$primarykey = 'partnerbilltype_id';
		...
		try {
			...
			$obj->partnerbilltype_id = strtoupper($obj->partnerbilltype_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'partnerbilltype_id', 'billtype_id', 'coa_id', 'unbill_coa_id', 'partner_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'billtype_name' => \FGTA4\utils\SqlUtility::Lookup($data->billtype_id, $this->db, 'mst_billtype', 'billtype_id', 'billtype_name'),
