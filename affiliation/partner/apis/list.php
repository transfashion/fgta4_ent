...
$API = new class extends partnerBase {
	...
	public function execute($options) {
		...
		try {
			...
			$sqlFieldList = [
				'partner_id' => 'A.`partner_id`', 'partnertype_id' => 'A.`partnertype_id`', 'empl_id' => 'A.`empl_id`', 'partnertype_isempl' => 'A.`partnertype_isempl`',
				'partnertype_isdefname' => 'A.`partnertype_isdefname`', 'partner_name' => 'A.`partner_name`', 'partner_addressline1' => 'A.`partner_addressline1`', 'partner_addressline2' => 'A.`partner_addressline2`',
				'partner_addressline3' => 'A.`partner_addressline3`', 'partner_city' => 'A.`partner_city`', 'partner_postcode' => 'A.`partner_postcode`', 'partner_country' => 'A.`partner_country`',
				'partner_phone' => 'A.`partner_phone`', 'partner_mobilephone' => 'A.`partner_mobilephone`', 'partner_email' => 'A.`partner_email`', 'partner_isdisabled' => 'A.`partner_isdisabled`',
				'partner_isparent' => 'A.`partner_isparent`', 'partner_parent' => 'A.`partner_parent`', 'partnerorg_id' => 'A.`partnerorg_id`', 'partner_npwp' => 'A.`partner_npwp`',
				'partner_isnonnpwp' => 'A.`partner_isnonnpwp`', 'ae_empl_id' => 'A.`ae_empl_id`', 'col_empl_id' => 'A.`col_empl_id`', '_createby' => 'A.`_createby`',
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('country_name', 'partner_country', $record, 'mst_country', 'country_name', 'country_id');
				$this->addFields('partner_parent_name', 'partner_parent', $record, 'mst_partner', 'partner_name', 'partner_id');
				$this->addFields('partnerorg_name', 'partnerorg_id', $record, 'mst_partnerorg', 'partnerorg_name', 'partnerorg_id');
				$this->addFields('ae_empl_name', 'ae_empl_id', $record, 'mst_empl', 'empl_name', 'empl_id');
				$this->addFields('col_empl_name', 'col_empl_id', $record, 'mst_empl', 'empl_name', 'empl_id');
