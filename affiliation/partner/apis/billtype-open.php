	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"partnerbilltype_id" => " partnerbilltype_id = :partnerbilltype_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_partnerbilltype', [
				'partnerbilltype_id', 'billtype_id', 'coa_id', 'unbill_coa_id', 'partner_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
