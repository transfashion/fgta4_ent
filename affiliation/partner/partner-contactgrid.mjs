...
import * as hnd from  './partner-contactgrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editcontactgrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editcontactgrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
