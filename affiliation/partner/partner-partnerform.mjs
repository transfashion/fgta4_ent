...
const obj = {
	txt_partnersite_id: $('#pnl_editpartnerform-txt_partnersite_id'),
	cbo_site_id: $('#pnl_editpartnerform-cbo_site_id'),
	txt_partner_id: $('#pnl_editpartnerform-txt_partner_id')
}
...
export async function init(opt) {
	...
	obj.cbo_site_id.name = 'pnl_editpartnerform-cbo_site_id'		
