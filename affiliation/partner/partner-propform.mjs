...
import * as hnd from  './partner-propform-hnd.mjs'
...
const obj = {
	txt_partnerprop_id: $('#pnl_editpropform-txt_partnerprop_id'),
	txt_partnerprop_key: $('#pnl_editpropform-txt_partnerprop_key'),
	txt_partnerprop_value: $('#pnl_editpropform-txt_partnerprop_value'),
	txt_partner_id: $('#pnl_editpropform-txt_partner_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_partnerprop_id,
		autoid: true,
		logview: 'mst_partnerprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_partnerprop_id
