...
import * as hnd from  './partner-bankgrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editbankgrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editbankgrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
