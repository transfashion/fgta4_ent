...
const obj = {
	...
	chk_partnertype_isdefname: $('#pnl_edit-chk_partnertype_isdefname'),
...
export async function init(opt) {
	...
	obj.cbo_partnertype_id.name = 'pnl_edit-cbo_partnertype_id'		
	...
	obj.cbo_partner_country.name = 'pnl_edit-cbo_partner_country'		
	...
	obj.cbo_partner_parent.name = 'pnl_edit-cbo_partner_parent'		
	...
	obj.cbo_partnerorg_id.name = 'pnl_edit-cbo_partnerorg_id'		
	...
	obj.cbo_ae_empl_id.name = 'pnl_edit-cbo_ae_empl_id'		
	...
	obj.cbo_col_empl_id.name = 'pnl_edit-cbo_col_empl_id'		
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['empl_id', 'partner_parent', 'ae_empl_id', 'col_empl_id', ];
