	...
	public function execute($options) {
		...
		try {
			...
			$sqlFieldList = [
				...
				'cust_isdisabled' => 'A.`cust_isdisabled`', 'cust_ishasbirthinfo' => 'A.`cust_ishasbirthinfo`', 'cust_birthdate' => 'A.`cust_birthdate`', 'cust_isrecvoffer' => 'A.`cust_isrecvoffer`',
				'cust_reasonrejectoffer' => 'A.`cust_reasonrejectoffer`', '_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`',
