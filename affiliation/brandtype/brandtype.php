...
if (is_file(__DIR__ .'/brandtype.php-handler.php')) {
	require_once __DIR__ .'/brandtype.php-handler.php';
}

/**
 * ent/affiliation/brandtype/brandtype.php
 *
 * ===================================================================
 * Entry point Program Module brandtype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\brandtype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new brandtype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
