...
if (is_file(__DIR__ .'/partnercategory.php-handler.php')) {
	require_once __DIR__ .'/partnercategory.php-handler.php';
}
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\partnercategory_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new partnercategory_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
