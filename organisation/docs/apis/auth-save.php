	...
	public function execute($data, $options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'docauth_id', 'docauth_descr', 'docauth_order', 'docauth_value', 'docauth_min', 'authlevel_id', 'auth_id', 'doc_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
