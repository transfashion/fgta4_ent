...
/**
 * ent/organisation/docs/apis/auth-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel auth docs (mst_docauth)
 *
...
$API = new class extends docsBase {
	...
	public function execute($data, $options) {
		...
		$handlerclassname = "\\FGTA4\\apis\\docs_authHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new docs_authHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
