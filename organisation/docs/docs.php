...
if (is_file(__DIR__ .'/docs.php-handler.php')) {
	require_once __DIR__ .'/docs.php-handler.php';
}

/**
 * ent/organisation/docs/docs.php
 *
 * ===================================================================
 * Entry point Program Module docs
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\docs_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new docs_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
