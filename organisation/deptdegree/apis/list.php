...
/**
 * ent/organisation/deptdegree/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header deptdegree (mst_deptdegree)
...
$API = new class extends deptdegreeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.deptdegree_id LIKE CONCAT('%', :search, '%') OR A.deptdegree_name LIKE CONCAT('%', :search, '%') "
			];
