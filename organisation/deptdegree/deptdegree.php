...
if (is_file(__DIR__ .'/deptdegree.php-handler.php')) {
	require_once __DIR__ .'/deptdegree.php-handler.php';
}

/**
 * ent/organisation/deptdegree/deptdegree.php
 *
 * ===================================================================
 * Entry point Program Module deptdegree
 * ===================================================================
 ...
 * awal dibuat tanggal 24/08/2024
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\deptdegree_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new deptdegree_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
