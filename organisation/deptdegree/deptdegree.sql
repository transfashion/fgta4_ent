...
ALTER TABLE `mst_deptdegree` ADD COLUMN IF NOT EXISTS  `authlevel_id` varchar(10) NOT NULL  AFTER `deptdegree_order`;
...
ALTER TABLE `mst_deptdegree` MODIFY COLUMN IF EXISTS  `authlevel_id` varchar(10) NOT NULL   AFTER `deptdegree_order`;


ALTER TABLE `mst_deptdegree` ADD CONSTRAINT `deptdegree_name` UNIQUE IF NOT EXISTS  (`deptdegree_name`);

ALTER TABLE `mst_deptdegree` ADD KEY IF NOT EXISTS `authlevel_id` (`authlevel_id`);

ALTER TABLE `mst_deptdegree` ADD CONSTRAINT `fk_mst_deptdegree_mst_authlevel` FOREIGN KEY IF NOT EXISTS  (`authlevel_id`) REFERENCES `mst_authlevel` (`authlevel_id`);
