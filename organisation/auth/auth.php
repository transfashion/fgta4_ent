...
if (is_file(__DIR__ .'/auth.php-handler.php')) {
	require_once __DIR__ .'/auth.php-handler.php';
}

/**
 * ent/organisation/auth/auth.php
 *
 * ===================================================================
 * Entry point Program Module auth
 * ===================================================================
 ...
 * terakhir di generate tanggal 01/09/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\auth_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new auth_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
