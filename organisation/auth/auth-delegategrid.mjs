...
import * as hnd from  './auth-delegategrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editdelegategrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editdelegategrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
