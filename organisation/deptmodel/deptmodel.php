...
if (is_file(__DIR__ .'/deptmodel.php-handler.php')) {
	require_once __DIR__ .'/deptmodel.php-handler.php';
}
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\deptmodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new deptmodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
