...
if (is_file(__DIR__ .'/depttype.php-handler.php')) {
	require_once __DIR__ .'/depttype.php-handler.php';
}

/**
 * ent/organisation/depttype/depttype.php
 *
 * ===================================================================
 * Entry point Program Module depttype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\depttype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new depttype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
