...
import * as hnd from  './unit-itemclassgrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloading = async (options) => {
		...
		options.criteria['id'] = data.unit_id
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_edititemclassgrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_edititemclassgrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
