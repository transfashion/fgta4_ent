...
if (is_file(__DIR__ .'/unit.php-handler.php')) {
	require_once __DIR__ .'/unit.php-handler.php';
}
 ...
 * terakhir di generate tanggal 12/08/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\unit_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new unit_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
