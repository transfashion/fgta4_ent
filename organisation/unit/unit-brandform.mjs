...
import * as hnd from  './unit-brandform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editbrandform-caption')
...
const obj = {
	txt_unitbrand_id: $('#pnl_editbrandform-txt_unitbrand_id'),
	cbo_brand_id: $('#pnl_editbrandform-cbo_brand_id'),
	txt_unit_id: $('#pnl_editbrandform-txt_unit_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_unitbrand_id,
		autoid: true,
		logview: 'mst_unitbrand',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_unitbrand_id
