...
import * as hnd from  './unit-brandgrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editbrandgrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editbrandgrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
