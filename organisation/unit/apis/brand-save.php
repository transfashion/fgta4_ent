...
/**
 * ent/organisation/unit/apis/brand-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel brand unit (mst_unitbrand)
 *
...
$API = new class extends unitBase {
	...
	public function execute($data, $options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new unit_brandHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			try {
				...
				// result
				$options->criteria = [
					"unitbrand_id" => $obj->unitbrand_id
				];

				$criteriaValues = [
					"unitbrand_id" => " unitbrand_id = :unitbrand_id "
				];
				...
				$sqlFieldList = [
					'unitbrand_id' => 'A.`unitbrand_id`', 'brand_id' => 'A.`brand_id`', 'unit_id' => 'A.`unit_id`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_unitbrand A";
				$sqlWhere = $where->sql;
