...
import * as hnd from  './unit-itemclassform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_edititemclassform-caption')
...
const obj = {
	txt_unititemclass_id: $('#pnl_edititemclassform-txt_unititemclass_id'),
	cbo_itemclass_id: $('#pnl_edititemclassform-cbo_itemclass_id'),
	txt_unit_id: $('#pnl_edititemclassform-txt_unit_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_unititemclass_id,
		autoid: true,
		logview: 'mst_unititemclass',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.unit_name)
	if (typeof hnd!=='undefined') { 
...
function form_idsetup(options) {
	var objid = obj.txt_unititemclass_id
