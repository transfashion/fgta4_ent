...
if (is_file(__DIR__ .'/unitgroup.php-handler.php')) {
	require_once __DIR__ .'/unitgroup.php-handler.php';
}

/**
 * ent/organisation/unitgroup/unitgroup.php
 *
 * ===================================================================
 * Entry point Program Module unitgroup
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\unitgroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new unitgroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
