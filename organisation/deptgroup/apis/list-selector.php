	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
					select 
					A.deptgroup_id, A.deptgroup_name, A.deptgroup_descr, A.deptgroup_parent, A.deptgroup_pathid, A.deptgroup_path, A.deptgroup_level, A.deptgroup_isexselect, A.depttype_id, A._createby, A._createdate, A._modifyby, A._modifydate 
