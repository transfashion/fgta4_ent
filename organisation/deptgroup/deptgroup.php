...
if (is_file(__DIR__ .'/deptgroup.php-handler.php')) {
	require_once __DIR__ .'/deptgroup.php-handler.php';
}

/**
 * ent/organisation/deptgroup/deptgroup.php
 *
 * ===================================================================
 * Entry point Program Module deptgroup
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\deptgroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new deptgroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
