...
if (is_file(__DIR__ .'/config.php-handler.php')) {
	require_once __DIR__ .'/config.php-handler.php';
}

/**
 * ent/general/config/config.php
 *
 * ===================================================================
 * Entry point Program Module config
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\config_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new config_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
