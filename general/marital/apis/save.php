...
/**
 * ent/general/marital/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends maritalBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->marital_descr=='') { $obj->marital_descr = '--NULL--'; }
			...
			try {
				...
				$sqlFieldList = [
					'marital_id' => 'A.`marital_id`', 'marital_name' => 'A.`marital_name`', 'marital_descr' => 'A.`marital_descr`', 'marital_ptkpval' => 'A.`marital_ptkpval`',
