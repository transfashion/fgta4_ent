...
import * as hnd from  './selector-edit-hnd.mjs'
...
const obj = {
	txt_selector_id: $('#pnl_edit-txt_selector_id'),
	txt_selector_text: $('#pnl_edit-txt_selector_text'),
	txt_selector_data: $('#pnl_edit-txt_selector_data')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_selector_id,
		autoid: false,
		logview: 'mst_selector',
