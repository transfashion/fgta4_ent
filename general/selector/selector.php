...
if (is_file(__DIR__ .'/selector.php-handler.php')) {
	require_once __DIR__ .'/selector.php-handler.php';
}

/**
 * ent/general/selector/selector.php
 *
 * ===================================================================
 * Entry point Program Module selector
 * ===================================================================
 ...
 * awal dibuat tanggal 25/08/2023
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\selector_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new selector_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
