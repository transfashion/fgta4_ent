...
/**
 * ent/general/selector/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header selector (mst_selector)
...
$API = new class extends selectorBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.selector_id LIKE CONCAT('%', :search, '%') OR A.selector_text LIKE CONCAT('%', :search, '%') "
			];
