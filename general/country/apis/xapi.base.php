 ...
 * kelas ini harus di-inherit untuk semua api pada modul country
 *
...
class countryBase extends WebAPI {
	...
	protected $main_tablename = "mst_country";
	protected $main_primarykey = "country_id";
	protected $main_field_version = "country_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*country*/.txt";
		// debug::disable();
