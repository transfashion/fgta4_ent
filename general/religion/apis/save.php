...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->religion_name = strtoupper($obj->religion_name);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'religion_id', 'religion_name', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
