...
module.exports = {
	...
	persistent: {
		'mst_religion' : {
			...
			data: {
				religion_id: {text:'ID', type: dbtype.varchar(3), null:false, uppercase: true, options:{required:true,invalidMessage:'ID harus diisi'}},
				religion_name: {text:'Religion Name', type: dbtype.varchar(30), null:false, uppercase: true, options:{required:true,invalidMessage:'Religion Name harus diisi'}}
			},
