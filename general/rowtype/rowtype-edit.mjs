...
const obj = {
	txt_rowtype_id: $('#pnl_edit-txt_rowtype_id'),
	txt_rowtype_name: $('#pnl_edit-txt_rowtype_name'),
	txt_rowtype_tag: $('#pnl_edit-txt_rowtype_tag')
}
