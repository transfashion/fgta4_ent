...
if (is_file(__DIR__ .'/familyrelation.php-handler.php')) {
	require_once __DIR__ .'/familyrelation.php-handler.php';
}

/**
 * ent/general/familyrelation/familyrelation.php
 *
 * ===================================================================
 * Entry point Program Module familyrelation
 * ===================================================================
 ...
 * awal dibuat tanggal 26/08/2024
 * terakhir di generate tanggal 26/08/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\familyrelation_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new familyrelation_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
