...
/**
 * ent/general/familyrelation/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header familyrelation (mst_familyrelation)
...
$API = new class extends familyrelationBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.familyrelation_id LIKE CONCAT('%', :search, '%') OR A.familyrelation_name LIKE CONCAT('%', :search, '%') "
			];
