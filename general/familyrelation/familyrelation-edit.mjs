...
import * as hnd from  './familyrelation-edit-hnd.mjs'
...
const obj = {
	txt_familyrelation_id: $('#pnl_edit-txt_familyrelation_id'),
	txt_familyrelation_name: $('#pnl_edit-txt_familyrelation_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_familyrelation_id,
		autoid: false,
		logview: 'mst_familyrelation',
...
function form_idsetup(options) {
	var objid = obj.txt_familyrelation_id
