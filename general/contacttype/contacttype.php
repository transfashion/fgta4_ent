...
if (is_file(__DIR__ .'/contacttype.php-handler.php')) {
	require_once __DIR__ .'/contacttype.php-handler.php';
}

/**
 * ent/general/contacttype/contacttype.php
 *
 * ===================================================================
 * Entry point Program Module contacttype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\contacttype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new contacttype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
