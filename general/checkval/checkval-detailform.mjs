...
const obj = {
	txt_checkvalopt_id: $('#pnl_editdetailform-txt_checkvalopt_id'),
	txt_checkvalopt_caption: $('#pnl_editdetailform-txt_checkvalopt_caption'),
	txt_checkvalopt_value: $('#pnl_editdetailform-txt_checkvalopt_value'),
	txt_checkvalopt_bgcolor: $('#pnl_editdetailform-txt_checkvalopt_bgcolor'),
	txt_checkval_id: $('#pnl_editdetailform-txt_checkval_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_checkvalopt_id,
		autoid: true,
		logview: 'mst_checkvalopt',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.checkval_caption)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.checkval_id= hdata.checkval_id
		data.detail_value = 0
...
function form_idsetup(options) {
	var objid = obj.txt_checkvalopt_id
