...
import * as hnd from  './periodemo-refform-hnd.mjs'
...
const obj = {
	txt_periodemoref_id: $('#pnl_editrefform-txt_periodemoref_id'),
	cbo_interface_id: $('#pnl_editrefform-cbo_interface_id'),
	txt_periodemoref_name: $('#pnl_editrefform-txt_periodemoref_name'),
	txt_periodemoref_code: $('#pnl_editrefform-txt_periodemoref_code'),
	txt_periodemoref_otherdata: $('#pnl_editrefform-txt_periodemoref_otherdata'),
	txt_periodemoref_notes: $('#pnl_editrefform-txt_periodemoref_notes'),
	txt_periodemo_id: $('#pnl_editrefform-txt_periodemo_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_periodemoref_id,
		autoid: true,
		logview: 'mst_periodemoref',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_periodemoref_id
