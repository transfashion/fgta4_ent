	...
	public function execute($options) {
		...
		try {
			...
			$sqlFieldList = [
				...
				'itemstock_source' => 'A.`itemstock_source`', 'itemstock_isdisabled' => 'A.`itemstock_isdisabled`', 'itemstock_ishascompound' => 'A.`itemstock_ishascompound`', 'itemstock_issellable' => 'A.`itemstock_issellable`',
				'itemstock_priceori' => 'A.`itemstock_priceori`', 'itemstock_priceadj' => 'A.`itemstock_priceadj`', 'itemstock_priceadjdate' => 'A.`itemstock_priceadjdate`', 'itemstock_grossprice' => 'A.`itemstock_grossprice`',
				'itemstock_isdiscvalue' => 'A.`itemstock_isdiscvalue`', 'itemstock_disc' => 'A.`itemstock_disc`', 'itemstock_discval' => 'A.`itemstock_discval`', 'itemstock_sellprice' => 'A.`itemstock_sellprice`',
				'itemstock_estcost' => 'A.`itemstock_estcost`', 'itemstock_weight' => 'A.`itemstock_weight`', 'itemstock_length' => 'A.`itemstock_length`', 'itemstock_width' => 'A.`itemstock_width`',
				'itemstock_height' => 'A.`itemstock_height`', 'itemstock_lastqty' => 'A.`itemstock_lastqty`', 'itemstock_lastvalue' => 'A.`itemstock_lastvalue`', 'itemstock_lastqtyupdate' => 'A.`itemstock_lastqtyupdate`',
				'itemstock_isupdating' => 'A.`itemstock_isupdating`', 'itemstock_updatebatch' => 'A.`itemstock_updatebatch`', 'itemstock_lastrecvid' => 'A.`itemstock_lastrecvid`', 'itemstock_lastrecvdate' => 'A.`itemstock_lastrecvdate`',
				'itemstock_lastrecvqty' => 'A.`itemstock_lastrecvqty`', 'itemstock_lastcost' => 'A.`itemstock_lastcost`', 'itemstock_lastcostdate' => 'A.`itemstock_lastcostdate`', 'itemstock_ref' => 'A.`itemstock_ref`',
