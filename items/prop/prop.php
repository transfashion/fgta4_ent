...
if (is_file(__DIR__ .'/prop.php-handler.php')) {
	require_once __DIR__ .'/prop.php-handler.php';
}

/**
 * ent/items/prop/prop.php
 *
 * ===================================================================
 * Entry point Program Module prop
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\prop_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new prop_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
