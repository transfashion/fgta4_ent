...
import * as hnd from  './prop-edit-hnd.mjs'
...
const obj = {
	txt_prop_id: $('#pnl_edit-txt_prop_id'),
	txt_prop_name: $('#pnl_edit-txt_prop_name'),
	txt_prop_descr: $('#pnl_edit-txt_prop_descr'),
	txt_prop_tags: $('#pnl_edit-txt_prop_tags')
}
