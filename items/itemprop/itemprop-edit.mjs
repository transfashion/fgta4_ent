...
import * as hnd from  './itemprop-edit-hnd.mjs'
...
const obj = {
	txt_itemprop_id: $('#pnl_edit-txt_itemprop_id'),
	txt_itemprop_name: $('#pnl_edit-txt_itemprop_name'),
	txt_itemprop_descr: $('#pnl_edit-txt_itemprop_descr'),
	txt_itemprop_tags: $('#pnl_edit-txt_itemprop_tags')
}
