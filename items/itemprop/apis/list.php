...
/**
 * ent/items/itemprop/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header itemprop (mst_itemprop)
...
$API = new class extends itempropBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.itemprop_id LIKE CONCAT('%', :search, '%') OR A.itemprop_name LIKE CONCAT('%', :search, '%') OR A.itemprop_tags LIKE CONCAT('%', :search, '%') "
			];
