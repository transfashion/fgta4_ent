...
if (is_file(__DIR__ .'/itemprop.php-handler.php')) {
	require_once __DIR__ .'/itemprop.php-handler.php';
}

/**
 * ent/items/itemprop/itemprop.php
 *
 * ===================================================================
 * Entry point Program Module itemprop
 * ===================================================================
 ...
 * awal dibuat tanggal 28/08/2024
 * terakhir di generate tanggal 28/08/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemprop_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemprop_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
