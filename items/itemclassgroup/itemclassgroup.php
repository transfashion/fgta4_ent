...
if (is_file(__DIR__ .'/itemclassgroup.php-handler.php')) {
	require_once __DIR__ .'/itemclassgroup.php-handler.php';
}

/**
 * ent/items/itemclassgroup/itemclassgroup.php
 *
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemclassgroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemclassgroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
