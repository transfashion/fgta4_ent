...
import * as hnd from  './itemmodel-propform-hnd.mjs'
...
const obj = {
	txt_itemmodelprop_id: $('#pnl_editpropform-txt_itemmodelprop_id'),
	cbo_prop_id: $('#pnl_editpropform-cbo_prop_id'),
	txt_itemmodelprop_order: $('#pnl_editpropform-txt_itemmodelprop_order'),
	txt_itemmodel_id: $('#pnl_editpropform-txt_itemmodel_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemmodelprop_id,
		autoid: true,
		logview: 'mst_itemmodelprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_prop_id.name = 'pnl_editpropform-cbo_prop_id'		
	new fgta4slideselect(obj.cbo_prop_id, {
		title: 'Pilih prop_id',
		returnpage: this_page_id,
		api: $ui.apis.load_prop_id,
		fieldValue: 'prop_id',
		fieldDisplay: 'prop_name',
		fields: [
			{mapping: 'prop_id', text: 'prop_id'},
			{mapping: 'prop_name', text: 'prop_name'}
		],
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.itemmodel_name)
...
*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_prop_id, record.prop_id, record.prop_name)
			.setViewMode()
			.rowid = rowid
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.itemmodel_id = hdata.itemmodel_id
		data.prop_value = 0

		data.itemmodelprop_order = 0

		data.prop_id = '0'
		data.prop_name = '-- PILIH --'
...
function form_idsetup(options) {
	var objid = obj.txt_itemmodelprop_id
