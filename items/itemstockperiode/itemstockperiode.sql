...
ALTER TABLE `mst_itemstockcost` ADD CONSTRAINT `fk_mst_itemstockcost_mst_room` FOREIGN KEY IF NOT EXISTS (`itemstock_id`) REFERENCES `mst_room` (`room_id`);
...
CREATE TABLE IF NOT EXISTS `mst_itemstocksaldo` (
	...
	`_modifyby` varchar(14)  , 
	`_modifydate` datetime  , 
	UNIQUE KEY `itemstocksaldo_pair` (`itemstocksaldo_id`, `dept_id`, `site_id`, `room_id`, `itemstock_id`),
...
ALTER TABLE `mst_itemstocksaldo` ADD COLUMN IF NOT EXISTS  `room_id` varchar(30) NOT NULL  AFTER `site_id`;
ALTER TABLE `mst_itemstocksaldo` ADD COLUMN IF NOT EXISTS  `itemstock_id` varchar(14) NOT NULL  AFTER `room_id`;
ALTER TABLE `mst_itemstocksaldo` ADD COLUMN IF NOT EXISTS  `itemstocksaldo_qty` decimal(14, 2)   AFTER `itemstock_id`;
...
ALTER TABLE `mst_itemstocksaldo` MODIFY COLUMN IF EXISTS  `room_id` varchar(30) NOT NULL   AFTER `site_id`;
ALTER TABLE `mst_itemstocksaldo` MODIFY COLUMN IF EXISTS  `itemstock_id` varchar(14) NOT NULL   AFTER `room_id`;
ALTER TABLE `mst_itemstocksaldo` MODIFY COLUMN IF EXISTS  `itemstocksaldo_qty` decimal(14, 2)    AFTER `itemstock_id`;
...
ALTER TABLE `mst_itemstocksaldo` ADD CONSTRAINT `itemstocksaldo_pair` UNIQUE IF NOT EXISTS  (`itemstocksaldo_id`, `dept_id`, `site_id`, `room_id`, `itemstock_id`);
...
ALTER TABLE `mst_itemstocksaldo` ADD CONSTRAINT `fk_mst_itemstocksaldo_mst_room_2` FOREIGN KEY IF NOT EXISTS (`itemstock_id`) REFERENCES `mst_room` (`room_id`);
