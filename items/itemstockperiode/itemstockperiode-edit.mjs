...
import * as hnd from  './itemstockperiode-edit-hnd.mjs'
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemstockperiode_id,
		autoid: true,
		logview: 'mst_itemstockperiode',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editcostgrid'].handler.createnew(data, options)
...
function form_idsetup(options) {
	var objid = obj.txt_itemstockperiode_id
