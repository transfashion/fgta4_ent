...
/**
 * ent/items/itemstockperiode/apis/cost-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel cost itemstockperiode (mst_itemstockcost)
...
$API = new class extends itemstockperiodeBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new itemstockperiode_costHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
