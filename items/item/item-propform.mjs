...
import * as hnd from  './item-propform-hnd.mjs'
...
const obj = {
	txt_itemprop_id: $('#pnl_editpropform-txt_itemprop_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemprop_id,
		autoid: true,
		logview: 'mst_itemprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
