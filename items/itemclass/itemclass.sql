...
CREATE TABLE IF NOT EXISTS `mst_itemclass` (
	...
	`asset_coa_id` varchar(17)  , 
	`depre_coa_id` varchar(17)  , 
...
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `cob_id` varchar(20)   AFTER `unitmeasurement_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `cost_coa_id` varchar(17)   AFTER `cob_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemmodel_id` varchar(10) NOT NULL  AFTER `cost_coa_id`;
...
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemclass_minassetvalue` decimal(11, 2) NOT NULL DEFAULT 0 AFTER `depremodel_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `asset_coa_id` varchar(17)   AFTER `itemclass_minassetvalue`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `depre_coa_id` varchar(17)   AFTER `asset_coa_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemclass_depreage` int(2) NOT NULL DEFAULT 5 AFTER `depre_coa_id`;
...
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `cob_id` varchar(20)    AFTER `unitmeasurement_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `cost_coa_id` varchar(17)    AFTER `cob_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `itemmodel_id` varchar(10) NOT NULL   AFTER `cost_coa_id`;
...
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `itemclass_minassetvalue` decimal(11, 2) NOT NULL DEFAULT 0  AFTER `depremodel_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `asset_coa_id` varchar(17)    AFTER `itemclass_minassetvalue`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `depre_coa_id` varchar(17)    AFTER `asset_coa_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `itemclass_depreage` int(2) NOT NULL DEFAULT 5  AFTER `depre_coa_id`;
...
ALTER TABLE `mst_itemclass` ADD KEY IF NOT EXISTS `asset_coa_id` (`asset_coa_id`);
...
ALTER TABLE `mst_itemclass` ADD CONSTRAINT `fk_mst_itemclass_mst_coa` FOREIGN KEY IF NOT EXISTS  (`cost_coa_id`) REFERENCES `mst_coa` (`coa_id`);
...
ALTER TABLE `mst_itemclass` ADD CONSTRAINT `fk_mst_itemclass_mst_coa_2` FOREIGN KEY IF NOT EXISTS  (`asset_coa_id`) REFERENCES `mst_coa` (`coa_id`);
ALTER TABLE `mst_itemclass` ADD CONSTRAINT `fk_mst_itemclass_mst_coa_3` FOREIGN KEY IF NOT EXISTS  (`depre_coa_id`) REFERENCES `mst_coa` (`coa_id`);
