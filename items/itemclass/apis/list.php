...
/**
 * ent/items/itemclass/apis/list.php
 *
 * ========
 * DataList
 * ========
	...
	public function execute($options) {
		...
		try {
			...
			$sqlFieldList = [
				...
				'itemmodel_id' => 'A.`itemmodel_id`', 'owner_dept_id' => 'A.`owner_dept_id`', 'maintainer_dept_id' => 'A.`maintainer_dept_id`', 'depremodel_id' => 'A.`depremodel_id`',
				'itemclass_depreage' => 'A.`itemclass_depreage`', 'itemclass_depreresidu' => 'A.`itemclass_depreresidu`', 'itemclass_isallowoverqty' => 'A.`itemclass_isallowoverqty`', 'itemclass_isallowoverdays' => 'A.`itemclass_isallowoverdays`',
				'itemclass_isallowovertask' => 'A.`itemclass_isallowovertask`', 'itemclass_isallowovervalue' => 'A.`itemclass_isallowovervalue`', 'itemclass_isallowunbudget' => 'A.`itemclass_isallowunbudget`', 'itemmanage_id' => 'A.`itemmanage_id`',
