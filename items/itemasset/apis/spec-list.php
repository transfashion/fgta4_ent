...
/**
 * ent/items/itemasset/apis/spec-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel spec itemasset (mst_itemassetspec)
...
$API = new class extends itemassetBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_specHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('itemspec_name', 'itemspec_id', $record, 'mst_itemspec', 'itemspec_name', 'itemspec_id');
