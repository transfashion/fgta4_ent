...
/**
 * ent/items/itemasset/apis/prop-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel prop itemasset (mst_itemassetprop)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('prop_name', 'prop_id', $record, 'mst_itemprop', 'prop_name', 'prop_id');
