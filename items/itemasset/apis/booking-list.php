...
/**
 * ent/items/itemasset/apis/booking-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel booking itemasset (mst_itemassetbooking)
...
$API = new class extends itemassetBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_bookingHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
