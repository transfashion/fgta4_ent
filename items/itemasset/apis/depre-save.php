...
if (is_file(__DIR__ .'/data-depre-handler.php')) {
	require_once __DIR__ .'/data-depre-handler.php';
}
...
/**
 * ent/items/itemasset/apis/depre-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel depre itemasset (mst_itemassetdepre)
 *
...
$API = new class extends itemassetBase {
	...
	public function execute($data, $options, $files) {
		...
		$handlerclassname = "\\FGTA4\\apis\\itemasset_depreHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_depreHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'itemassetdepre_id', 'itemassetdepre_date', 'itemassetdepre_value', 'itemassetdepre_ref',
					'itemasset_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"itemassetdepre_id" => $obj->itemassetdepre_id
				];
				...
				$sqlFieldList = [
					'itemassetdepre_id' => 'A.`itemassetdepre_id`', 'itemassetdepre_date' => 'A.`itemassetdepre_date`', 'itemassetdepre_value' => 'A.`itemassetdepre_value`', 'itemassetdepre_ref' => 'A.`itemassetdepre_ref`',
					'itemasset_id' => 'A.`itemasset_id`', '_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_itemassetdepre A";
				$sqlWhere = $where->sql;
