...
/**
 * ent/items/itemasset/apis/files-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel files itemasset (trn_inquiryfiles)
 *
...
$API = new class extends itemassetBase {
	...
	public function execute($data, $options, $files) {
		...
		$handlerclassname = "\\FGTA4\\apis\\itemasset_filesHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_filesHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'inquiryfiles_id', 'doctype_id', 'inquiryfiles_descr', 'inquiryfiles_order',
					'inquiryfiles_file', 'inquiry_id'
			];
