...
/**
 * ent/items/itemasset/apis/moving-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel moving itemasset (log_itemassetmoving)
 *
...
$API = new class extends itemassetBase {
	...
	public function execute($data, $options, $files) {
		...
		$handlerclassname = "\\FGTA4\\apis\\itemasset_movingHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_movingHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'itemassetmoving_id', 'itemassetmoving_date', 'itemassetmoving_ref', 'itemassetmoving_typename',
					'dept_name', 'site_name', 'empl_name', 'itemasset_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"itemassetmoving_id" => $obj->itemassetmoving_id
				];
				...
				$sqlFieldList = [
					'itemassetmoving_id' => 'A.`itemassetmoving_id`', 'itemassetmoving_date' => 'A.`itemassetmoving_date`', 'itemassetmoving_ref' => 'A.`itemassetmoving_ref`', 'itemassetmoving_typename' => 'A.`itemassetmoving_typename`',
					'dept_name' => 'A.`dept_name`', 'site_name' => 'A.`site_name`', 'empl_name' => 'A.`empl_name`', 'itemasset_id' => 'A.`itemasset_id`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "log_itemassetmoving A";
				$sqlWhere = $where->sql;
