...
if (is_file(__DIR__ .'/data-maintenance-handler.php')) {
	require_once __DIR__ .'/data-maintenance-handler.php';
}
...
/**
 * ent/items/itemasset/apis/maintenance-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel maintenance itemasset (log_itemassetmaintenace)
...
$API = new class extends itemassetBase {
	...
	public function execute($options) {
		...
		$handlerclassname = "\\FGTA4\\apis\\itemasset_maintenanceHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_maintenanceHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlFieldList = [
				'itemassetmaintenace_id' => 'A.`itemassetmaintenace_id`', 'itemassetmaintenace_date' => 'A.`itemassetmaintenace_date`', 'itemassetmaintenace_ref' => 'A.`itemassetmaintenace_ref`', 'itemassetmaintenace_typename' => 'A.`itemassetmaintenace_typename`',
				'itemassetmaintenace_status' => 'A.`itemassetmaintenace_status`', 'partner_name' => 'A.`partner_name`', 'itemasset_id' => 'A.`itemasset_id`', '_createby' => 'A.`_createby`',
				'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
			];
			$sqlFromTable = "log_itemassetmaintenace A";
			$sqlWhere = $where->sql;
