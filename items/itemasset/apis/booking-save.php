...
if (is_file(__DIR__ .'/data-booking-handler.php')) {
	require_once __DIR__ .'/data-booking-handler.php';
}
...
/**
 * ent/items/itemasset/apis/booking-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel booking itemasset (mst_itemassetbooking)
 *
...
$API = new class extends itemassetBase {
	...
	public function execute($data, $options, $files) {
		...
		$handlerclassname = "\\FGTA4\\apis\\itemasset_bookingHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_bookingHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'itemassetbooking_id', 'itemassetbooking_date', 'assetbooking_id', 'itemasset_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"itemassetbooking_id" => $obj->itemassetbooking_id
				];
				...
				$sqlFieldList = [
					'itemassetbooking_id' => 'A.`itemassetbooking_id`', 'itemassetbooking_date' => 'A.`itemassetbooking_date`', 'assetbooking_id' => 'A.`assetbooking_id`', 'itemasset_id' => 'A.`itemasset_id`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_itemassetbooking A";
				$sqlWhere = $where->sql;
