...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editmovinggrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editmovinggrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
