...
import * as hnd from  './itemasset-propform-hnd.mjs'
...
const obj = {
	txt_itemassetprop_id: $('#pnl_editpropform-txt_itemassetprop_id'),
	cbo_prop_id: $('#pnl_editpropform-cbo_prop_id'),
	txt_itemassetprop_value: $('#pnl_editpropform-txt_itemassetprop_value'),
	txt_itemassetprop_order: $('#pnl_editpropform-txt_itemassetprop_order'),
	txt_itemasset_id: $('#pnl_editpropform-txt_itemasset_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemassetprop_id,
		autoid: true,
		logview: 'mst_itemassetprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_itemassetprop_id
