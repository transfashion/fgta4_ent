...
if (is_file(__DIR__ .'/itemasset.php-handler.php')) {
	require_once __DIR__ .'/itemasset.php-handler.php';
}

/**
 * ent/items/itemasset/itemasset.php
 *
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemasset_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemasset_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
