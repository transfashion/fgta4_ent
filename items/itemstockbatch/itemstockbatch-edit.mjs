...
import * as hnd from  './itemstockbatch-edit-hnd.mjs'
...
const obj = {
	txt_itemstockbatch_id: $('#pnl_edit-txt_itemstockbatch_id'),
	txt_itemstockbatch_name: $('#pnl_edit-txt_itemstockbatch_name'),
	dt_itemstockbatch_exp: $('#pnl_edit-dt_itemstockbatch_exp'),
	chk_itemstockbatch_isdisabled: $('#pnl_edit-chk_itemstockbatch_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemstockbatch_id,
		autoid: true,
		logview: 'mst_itemastockbatch',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.itemstockbatch_exp = global.now()
		data.itemstockbatch_isdisabled = '1'
...
function form_idsetup(options) {
	var objid = obj.txt_itemstockbatch_id
